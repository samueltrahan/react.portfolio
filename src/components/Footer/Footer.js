  ...
  return (
    <div className="footer">
      <div className="copy-right">
        <p className="copy">&copy; 2020 - Samuel Trahan</p>
      </div>
      <div className="social-links">
        ...
        <a className="social" target="_blank" rel="noreferrer" href="https://github.com/samueltrahan"><i className="twitter fab fa-twitter fa-3x"></i></a>
      </div>
    </div>
  )
}
