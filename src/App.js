  ...
  return (
    ...
    <Router>
      ...
      <div>
        ...
        <Projects path="https://trippin-cwd.herokuapp.com/" image={Pic02} head="React" title="Trippin'" paragraph="Trippin' is a full MERN stack application for planning trips and searching for things to do on your vacation. This application was made by the team at Cinque Web Development." />
